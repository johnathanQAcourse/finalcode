...
class TestDeckOfCards(TestCase):
    ...
    def test_cards_shuffle(self):
        """test to see if deck actually kept all the cards"""
    ...
    def test_cards_shuffle_2(self):
        """test to see if two decks with the same cards are not identical in order."""
        shuffled_deck = DeckOfCards() #52 cards
        shuffled_deck.cards_shuffle() #after shuffling
        self.assertNotEqual(self.deck.deck, shuffled_deck.deck)
    ...
    def test_deal_one_4_with_already_removed_card(self):
